...
const Policy = () => {
  return (
    ...
    <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-6 dark-color uppercase text-center">Blogify Team</h1>
        <h1 className="text-2xl font-bold mb-4 links ">Privacy Policy</h1>

        <p className="mb-4 dark-color">
            This privacy policy sets out how our website uses and protects any information that you give us when you use
            this
            website.
        </p>

        <h2 className="text-2xl links  font-bold mb-2">Information We Collect</h2>
        ...
        <h2 className="text-2xl links  font-bold mb-2">How We Use the Information</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 links">Security</h2>
        ...
        <h2 className="text-2xl font-bold links mb-2">Cookies</h2>
        ...
        <h2 className="text-2xl font-bold links mb-2">Links to Other Websites</h2>
        ...
        <h2 className="text-2xl font-bold links  mb-2">Controlling Your Personal Information</h2>
