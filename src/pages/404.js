  ...
  return (
    ...
    <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div className="flex flex-col items-center max-w-sm mx-auto text-center">
            <p className="p-3 text-sm font-medium p-notfound rounded-full bg-blue-50 dark:bg-gray-800">
            ...
            <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                ...
                <Link className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 rounded-lg shrink-0 sm:w-auto primary-btn " href="/">
                    Take me home
                </Link>
            </div>
        </div>
